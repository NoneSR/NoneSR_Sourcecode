...
from utils import MeanShift, Conv2d1x1, Conv2d3x3, ShiftConv2d1x1, \
...
if __name__ == '__main__':
    ...
    net = ESWT(upscale=2, n_t=6, n_g=3, dim=60, num_in_ch=3,num_out_ch=3,task='lsr').cuda()


    data = torch.randn(1, 3, 640,360).cuda()
    net(data)
