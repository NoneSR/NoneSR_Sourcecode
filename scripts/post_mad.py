...
def cal_mean_distance_fast(pkl_path, window_list: tuple = ((32, 8), (8, 32))):
...
def plot_mad(pkl_path):
    ...
    plt.plot(x, md_mean,color='blue',marker='p',)
    ...
    plt.savefig('figs/LGTT/mad_new_3SA_3PM_DIV2K_test.png')
