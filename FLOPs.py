import argparse
from archs.elan_arch import ELAN
# from archs.esrt_arch import ESRT
import torch
...
def profile(model, input_size, custom_ops={}, device="cpu"):
    ...
    return total_ops/ 1e9, total_params
net = ELAN(upscale=2, num_in_ch=3, num_out_ch=3, planes=60, window_sizes=(4, 8, 16), num_blocks=24,
               n_share=1, img_size=(320, 180), task='lsr')
# net = ESRT(upscale=4, num_in_ch = 3, num_out_ch = 3, task = 'lsr')
net.eval()
print(profile(net, input_size=(1, 3, 320, 180)))
