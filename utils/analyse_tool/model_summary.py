...
def get_model_flops(model, input_res, print_per_layer_stat=False,
...
def get_model_complexity_info(model, input_res, print_per_layer_stat=False, as_strings=True,
                              input_constructor=None):
